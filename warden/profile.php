        ...
        <div class='col-md-6 col-md-offset-3'>
          ...
          <form action='update_profile.php' method='POST' role='form' class='contactForm'>
            ...
            if($conn)
            {
              ...
              echo "
              <div class='form-group'>
               <l style='color:pink'>LOGIN_ID : $row[email]</l>
           </div>

            <div class='form-group'>
              <l>PASSWORD :</l><input type='text' name='password' class='form-control' id='name' value='$row[password]'  />
              <div class='validation'></div>
            </div>
            <div class='form-group'>
             <l>YOUR_NAME :</l> <input type='text' name='your_name' class='form-control' id='fname' value='$row[your_name]'  />
              <div class='validation'></div>
            </div>
            

            <div class='form-group'>
              <l>COLLEGE_NAME :</l><input type='text' name='college_name' class='form-control' id='mname' value='$row[college_name]' />
              <div class='validation'></div>
            </div>
...
<option value='Valsad'>Valsad</option>
            ...
            <div class='form-group'>
            <l>CONTACT_NUMBER :</l>
              <input type='number' class='form-control' name='contact' id='subject' value='$row[contact]' />
              <div class='validation'></div>
            </div>
