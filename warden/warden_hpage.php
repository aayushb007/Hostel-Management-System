          ...
          <div class='navbar-collapse collapse'>
            <div class='menu'>
              <ul class='nav nav-tabs' role='tablist'>
                <li role='presentation'><a href='warden_hpage.php' class='active'>Home</a></li>
            ...
            <div class='row slide-margin'>
              <div class='col-sm-6'>
                <div class='carousel-content'>
                  <h2 class='animation animated-item-1'>Welcome To <l style='color:red'>Your Website</l>    <span>Hostel <br>Management System</span></h2>
