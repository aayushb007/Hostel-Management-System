          ...
          <div class='navbar-collapse collapse'>
            <div class='menu'>
              <ul class='nav nav-tabs' role='tablist'>
                ...
                <li role='presentation'";?><a href='logout.php' onclick="return confirm('Do You Really Whant To Logout....?')">Logout</a><?php 
                echo "</li>
              </ul>
            </div>
          </div>
      ...
      <div class='row contact-wrap'>
        ...
        <div class='col-md-6 col-md-offset-3'>
          ...
          <form action='update_profile.php' method='POST' role='form' class='contactForm'>
            ...
            <div class='form-group'>
              <input type='text' name='lname' class='form-control' id='name' value='$row[lname]'  />
              <div class='validation'></div>
            </div>
...
<option value='Valsad'>Valsad</option>
           ...
           <div class='form-group'>
            ...
            <div class='form-group'>
              <input type='password' class='form-control' name='password' id='subject' value='$row[password]' />
              <div class='validation'></div>
            </div>
            ...
            <div class='text-center'><button type='submit' name='update.php' class='btn btn-primary btn-lg' >Update</button></div>
          </form>
        </div>
      </div>
      <!--/.row-->
